    ...
    L: PmCopy + LogicalRange + Sized + std::fmt::Debug,
{
    exec fn read_list(
        ...
        Ghost(list_addrs): Ghost<ISet<u64>>,
    ...
    exec fn build_free_list(
        ...
        sm: &ListTableStaticMetadata
    ) -> (result: (Vec<u64>, Ghost<IMap<u64, ListRowDisposition>>))
        requires
            sm.valid::<L>(),
        ensures
        ({
        ...
        })
    {
        ...
        let ghost row_info = IMap::<u64, ListRowDisposition>::empty();
            ...
            }
    {
        ...
        let lists = Self{
            ...
            m,
            deletes_inverse: Ghost(IMap::<u64, nat>::empty()),
